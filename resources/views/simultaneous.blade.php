   ...
   <div class="hero">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">Simultaneous Interpretation </h2>
                        <p class="hero-text"> </p>
                       <!-- <div class="price-rate">
                        ...
                        <a href="#" class="btn btn-default btn-sm">You Can Send Your Document For Online Translation</a>
                    </div>
                </div>
    ...
    <div class="section-space100">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <img src="images/lp-feature-img.jpg" alt="">
                </div>
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1>Alboraq Provides Certified Professional Simultaneous Interpretation</h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3>Alboraq Pioneer In Simultaneous Interpretation</h3>
                                    <p> our certified professional translation agency has the top simultaneous interpreters in egypt providing the most reliable interpretations for critical communications.</p>
                                </div>
                            </div>
                        </div>
