...
@section('content')
   ...
   <div class="hero">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="hero-captions">
                        <h2 class="hero-title">Content Creation & Development Service</h2>
                        <p class="hero-text"> </p>
                       <!-- <div class="price-rate">
                        ...
                        <a href="#" class="btn btn-default btn-sm"> Send Your Document For Online Translation</a>
                    </div>
                </div>
    ...
    <div class="section-space100">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <img src="{!!asset('images/lp-feature-img.jpg')!!}" alt="">
                </div>
                <div class="col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb60">
                                <h1>You Have An Idea But You Don't Know How To Write Or Express It In Another Language ?? </h1>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                ...
                                <div class="feature-content">
                                    <h3>Why Do You Need Content Creation And Development ?</h3>
                                    <p>Content is king. Your ideas are as good as the words you use to explain them. However, for many businesses, content development is a key issue.</p>
                                </div>
                            </div>
                        </div>
 ...
 <div class="col-md-12">
                            <div class="feature feature-left mb40">
                                <div class="feature-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="feature-content">
                                    <h3>how do you ensure that the right words are chosen to explain or market your product or service in the right way ? </h3>
                                    <p> This is exactly where Linguavista jumps in. With our experienced team of content writers, you will always be a step ahead of the others.</p>
                                </div>
                            </div>
                        </div>
